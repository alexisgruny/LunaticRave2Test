...
<div class="container-fluid">
    <div class="bg-dark offset-md-2 col-md-8 border-dark card mt-5 font-text">
        <div class="text-center text-white card-text mt-5 ">
            <h1 class="blue-text font-weight-bold">Terminologie des BMS </h1>
            ...
            <h2 class="blue-text font-weight-bold">BMS / BME / BML / PMS</h2>
            ...
            <h3 class="blue-text font-weight-bold">LN / CN / HCN</h3>
            ...
            <h4 class="blue-text font-weight-bold">差分 - Sabun</h4>
            ...
            <h5 class="blue-text font-weight-bold">Dan</h5>
            ...
            <h6 class="blue-text font-weight-bold">発狂BMS - Hakkyo BMS</h6>
            ...
            <h7 class="blue-text font-weight-bold">皿 - Sara - TT</h7>
            <p>Ce terme traduit veut dire "Assiette", et se réfère au scratch.</p>

            <h8 class="blue-text font-weight-bold">SP / DP</h8>
